...
class PriceList extends React.Component {
    ...
    componentDidMount = () => {
        ...
        title[0].innerHTML = "Usługi krawieckie";
        let description = document.createElement("meta");
        description.setAttribute("name", "description");
        description.setAttribute("content", "Szeroki zakres usług krawieckich - skracanie, zwężanie spodni, koszul, marynarek, szycie na miarę");
    ...
    render() {
        ...
        const dropdownList = (
            ...
            <button name="spodnie" className="price-list-option" id="spodnie" onClick={this.handlePriceButtonClick}>SPODNIE</button>
            <button name="plaszcz"className="price-list-option" id="plaszcz" onClick={this.handlePriceButtonClick}>PŁASZCZ/MARYNARKA</button>
            <button name="koszula"className="price-list-option" id="koszula" onClick={this.handlePriceButtonClick}>KOSZULA</button>
            <button name="sukienka"className="price-list-option" id="sukienka" onClick={this.handlePriceButtonClick}>SUKIENKA</button>
            <button name="spodnica"className="price-list-option" id="spodnica" ooClick={this.handlePriceButtonClick}>SPÓDNICA</button>
            <button name="kurtka"className="price-list-option" id="kurtka" onClick={this.handlePriceButtonClick}>KURTKA</button>
            <button name="inne"className="price-list-option" id="inne" onClick={this.handlePriceButtonClick}>INNE</button>
            </div>
        )
        return(
            <div>
                ...
                <div className="price-list-overall">
                        ...
                        <div className="price-list-container" id="price-list-container">
                            <div className="price-list-buttons">
                                <div><button name="spodnie"className="price-list-button button" id="spodnie" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>SPODNIE</button></div>
                                <div><button name="plaszcz"className="price-list-button button" id="plaszcz" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>PŁASZCZ/   MARYNARKA</button></div>
                                <div><button name="koszula"className="price-list-button button" id="koszula" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>KOSZULA</button></div>
                                <div><button name="sukienka"className="price-list-button button" id="sukienka" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>SUKIENKA</button></div>
                                <div><button name="spodnica"className="price-list-button button" id="spodnica" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>SPÓDNICA</button></div>
                                <div><button name="kurtka"className="price-list-button button" id="kurtka" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>KURTKA</button></div>
                                <div><button name="inne" className="price-list-button button" id="inne" onTouchEnd={this.handlePriceButtonClick} onClick={this.handlePriceButtonClick}>INNE</button></div>
                            </div>
